...
if (process.env.RUNNER === 'CI') {
  ...
  var junitReporter = jasmineJUnitReporter({
    ...
    JUnitReportFilePrefix: process.env.FILE_PREFIX || 'deep-freeze-results-' +  process.version,
    JUnitReportSuiteName: 'Deep Freeze Reports',
    JUnitReportPackageName: 'Deep Freeze Reports'
  });
